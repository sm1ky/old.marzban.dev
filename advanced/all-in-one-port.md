...
![](</static/old/photo_2023-09-23_16-23-38.jpg>)

В этом руководстве мы используем инструмент HAProxy для достижения нашей цели.

В дальнейшем предполагается, что поддомен панели - `panel.example.com` , поддомен, связанный с TLS-конфигурациями - `sub.example.com` и используется адрес SNI в конфигурации REALITY - `reality.com`.
...
В конце также приведены некоторые дополнительные замечания.
