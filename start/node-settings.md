...
**Совет второй**
Если вы хотите использовать Warp на сервере узла и настроили файл `docker-compose.yml` с использованием второго способа, вам нужно активировать Warp в варианте outbound Xray. Если вы используете вариант с системным ядром Wireguard, Warp на сервере узла не будет работать.
