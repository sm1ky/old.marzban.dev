...
{% hint style="warning" %}
Данная версия предназначена для `DEV` версии Marzban, если Вы используете `LATEST` версию панели, пожалуйста, обратитесь к следующей версии руководства:
{% endhint %}

[!ref Настройка узла для `LATEST`](/start/node-settings-old.md)
